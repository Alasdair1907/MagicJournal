...
<div class="side-panel-container side-panel-container-size">
    ...
    <div class="side-panel-image-div side-panel-image-div-size hlat-panel-image-override" style="background-image: url('getImage.jsp?filename={{this.titleImageVO.thumbnail}}')"></div>
...
<div class="side-panel-container side-panel-container-size">
    ...
    <div class="side-panel-image-div side-panel-image-div-size hlat-panel-image-override" style="background-image: url('getImage.jsp?filename={{this.imageVO.thumbnail}}')"></div>
    <span class="text-main side-panel-title">{{this.title}}</span><span class="mobile-hide"><br /></span>
</div>
</a>
`;
...
<div class="side-panel-container side-panel-container-size">
    ...
    <div class="side-panel-image-div side-panel-image-div-size hlat-panel-image-override" style="background-image: url('getImage.jsp?filename={{this.galleryRepresentation.[0].thumbnail}}')"></div>
    <span class="text-main side-panel-title">{{this.title}}</span><span class="mobile-hide"><br /></span>
</div>
</a>
`;
