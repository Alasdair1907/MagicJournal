...
import com.terrestrialjournal.to.PhotoTO;
...
public class PhotoService extends PostService {
    ...
    public static String getPrerenderByPhotoId(Long photoId, String userGuid, Session session){
        PhotoEntity photoEntity = (PhotoEntity) PhotoDao.getPostEntityById(photoId, PhotoEntity.class, session);
        if (photoEntity == null){
            return null;
        }
        ...
        return photoEntity.getPreRender();
    }
    ...
    public static JsonAdminResponse<Long> createOrUpdatePhoto(PhotoTO photoTO, Session session){
        ...
        photoEntity.setPreRender(photoTO.preRender);
