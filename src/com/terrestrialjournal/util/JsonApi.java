...
import com.terrestrialjournal.filter.BasicFileFilter;
...
import com.terrestrialjournal.to.*;
...
public class JsonApi {
    ...
    static {
        ...
        actionToErrorMessage.put("updatePhotoRender", "Error updating photo render");
        actionToFunction.put("updatePhotoRender", (JsonApiRequestContext request) -> {
            ...
            return PostService.updatePostRender(renderRequest.postId, renderRequest.render,
                    PostAttribution.PHOTO, request.userGuid, request.session);
        });
        ...
        actionToErrorMessage.put("updateGalleryRender", "Error updating gallery render");
        actionToFunction.put("updateGalleryRender", (JsonApiRequestContext request) -> {
            UpdateRenderRequest renderRequest = request.objectMapper.readValue(request.data, UpdateRenderRequest.class);
            return PostService.updatePostRender(renderRequest.postId, renderRequest.render,
                    PostAttribution.GALLERY, request.userGuid, request.session);
        });
        ...
        actionToErrorMessage.put("updateArticleRender", "Error updating article render");
        actionToFunction.put("updateArticleRender", (JsonApiRequestContext request) -> {
            UpdateRenderRequest renderRequest = request.objectMapper.readValue(request.data, UpdateRenderRequest.class);
            return PostService.updatePostRender(renderRequest.postId, renderRequest.render,
